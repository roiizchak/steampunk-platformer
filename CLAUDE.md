...
Measured against Phaser 4.2.1. Detail and citations in [docs/QA-LOG.md](docs/QA-LOG.md) Phase 1.
...
`window.__phaserGame` is also dev-only, and exists so e2e can restart the Boot scene.
