...
import { verifyIndexHtml } from './verifyIndexHtml.mjs';
...
// Criterion 12.13's shipped half and the page-identity half both read `dist/index.html`.
// `verifyIndexHtml.mjs` holds them; read its header for why they live one file over.
problems.push(...verifyIndexHtml(root));
