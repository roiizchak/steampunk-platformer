# Gate 5 — the style probe on the retired model

Gates 5 through 9, **21 generations on `fal-ai/nano-banana-2`**, $1.68. The model was retired at
gate 7; these entries predate the request-id contract and are **not rebuildable**.
