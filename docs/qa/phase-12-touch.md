...
**12.23 is NOT MET — rounds 21, 22 and 23 all ran and all three returned `VERDICT: REVISE`, which is the cap the owner set. Every finding from all three is applied. 12.13, 12.14 and 12.14b all await
