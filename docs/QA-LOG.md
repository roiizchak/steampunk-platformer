...
| — Tier-5 false gates, gate holes, the capture round (not a phase) | [qa/session-tier5-gate-holes.md](qa/session-tier5-gate-holes.md) + [-02-tweens](qa/session-tier5-gate-holes-02-tweens.md) + [-03-sweep](qa/session-tier5-gate-holes-03-sweep.md) + [-04-briefs](qa/session-tier5-gate-holes-04-briefs.md) | [plan](reviews/session-tier5-gate-holes-plan.md) · [impl](reviews/session-tier5-gate-holes-impl.md) | plan ✅ **three rounds, REVISE each** · impl ✅ **BLOCK, 11 findings, all 11 applied** — incl. a 9.3 teardown rule that stayed GREEN on a real violation. Full sweep green after it: e2e 136 + 109, unit 169/2541, sim-isolated 2538 + 3 skipped, build ok |
