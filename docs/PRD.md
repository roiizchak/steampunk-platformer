...
| 9 | Polish, juice, particles | [phase-09-polish.md](prd/phase-09-polish.md) | 8 | ⚠️ **NOT done — 9.5 is FAILING, owner decision owed.** The owner round Phase 9 was owed ran 2026-08-24: 9.1, 9.2, 9.3, 9.4, 9.7 and 9.9 all **PASS** (two real defects found and fixed, one construction refuted by execution, 9.7’s e2e redness discharged by six integrator-run mutations). **9.5 does not pass.** Its criterion says *max enemies + max particles + shake*; the measurement carries **no combat** and the **smallest** of four shakes, and the log itself calls the defence *“an argument and not a measurement”*. It was briefly marked done as *“PASS, qualified”* and the Codex implementation review blocked that as a bare PASS wearing a caveat — correctly. See [qa/phase-09-polish.md § The close round](qa/phase-09-polish.md) |
