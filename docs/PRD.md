...
- **The fal touch-UI-spend ceiling is `$5`**, set by owner decision on **2026-08-29 before Phase
  ...
  retries. **Running total: `$0.45`** — three touch-plate takes, `request_id`s
  `01a04e0b-ec39-7200-97bc-3afbd338ffeb` and `01a04e0e-d45d-7ab2-be31-a7c2f479a495` (2026-08-29,
  **neither adopted**) and `01a05115-d226-72b2-ae41-8998a11940cf` (2026-08-30, **ADOPTED** — the six
  faces in `public/assets/ui/`). See
